...
AFRAME.registerComponent("markerhandler", {
  ...
  handleRatings: async function (dish) {
   ...
   //getting table number
   var tNumber;
   tableNumber <= 9 ? (tNumber = `T${tableNumber}`) : `T${tableNumber}`;
   ...
   var currentOrders = Object.keys(orderSummary.current_orders);
    ...
    if (currentOrders.length > 0 && currentOrders==dish.id){
      //close modal
      document.getElementByIdById("rating-modal-div").style.display = "flex";
      document.getElementByIdById("rating-input").value = "0";
      document.getElementByIdById("feedback-input").value = "";
      ...
      saveRatingButton.addEventListener("click", () => {
        ...
        .then(() => {
          swal({
            ...
            test: "We Hope You Liked the Dish!!",
            timer:2500,
            buttons:false
